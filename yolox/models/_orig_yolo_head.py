...
class YOLOXHead(nn.Module):
    ...
    def get_assignments(
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            ######## EDIT ##################
            ################################
            print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX CLS_PREDS_ Type = {cls_preds_.type()}")
            print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX CLS_PREDS_ Type = {cls_preds_.shape}")
            print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX cls_preds_.unsqueeze(0) = {cls_preds_.unsqueeze(0).type()}")
            print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX cls_preds_.unsqueeze(0) = {cls_preds_.unsqueeze(0).shape}")
