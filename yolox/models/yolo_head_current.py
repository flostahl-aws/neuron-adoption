...
class YOLOXHead(nn.Module):
    ...
    def get_losses(
        ...
        bbox_preds_cpu = outputs.to('cpu')[:, :, :4]  # [batch, n_anchors_all, 4]
        obj_preds_cpu = outputs.to('cpu')[:, :, 4:5]  # [batch, n_anchors_all, 1]
        cls_preds_cpu = outputs.to('cpu')[:, :, 5:]  # [batch, n_anchors_all, n_cls]

        ############
        print(f"YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY line 265 outputs = {outputs}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 bbox_preds_cpu = {bbox_preds_cpu}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 bbox_preds_cpu = {bbox_preds_cpu.type()}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 obj_preds_cpu = {obj_preds_cpu}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 obj_preds_cpu = {obj_preds_cpu.type()}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 cls_preds_cpu = {cls_preds_cpu}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 cls_preds_cpu = {cls_preds_cpu.type()}")

        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 bbox_preds = {bbox_preds}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 bbox_preds = {bbox_preds.type()}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 obj_preds = {obj_preds}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 obj_preds = {obj_preds.type()}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 cls_preds = {cls_preds}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 265 cls_preds = {cls_preds.type()}")
        ...
        for batch_idx in range(outputs.shape[0]):
            ...
            if num_gt == 0:
                ...
                ############
                print(f"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX line 331 bboxes_preds_per_image = {bboxes_preds_per_image}")
    ...
    def get_assignments(
        ...
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 522  pair_wise_ious = { pair_wise_ious}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 522  pair_wise_ious.shape = { pair_wise_ious.shape}")
        gt_cls_per_image = (
            F.one_hot((gt_classes.to('cpu')).to(torch.int64), self.num_classes)
            .float()
        )

        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 504  gt_cls_per_image = { gt_cls_per_image}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 504  gt_cls_per_image.dtype = { gt_cls_per_image.dtype}")
        gt_cls_per_image = gt_cls_per_image.to(device = 'xla')
        ...
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 522  pair_wise_ious_loss = { pair_wise_ious_loss}")
        print(f"XXXXXXXXXXXXXXXXXXXXXXXXXX line 522  pair_wise_ious_loss.shape = { pair_wise_ious_loss.shape}")
